...
module.exports = function (grunt) {
  ...
  //ejecuta tareas adicionales y opcionales
  require('load-grunt-tasks')(grunt);

  // load jade i18n tasks
  ...
  grunt.initConfig({
    ...
    open: {
      server: {
        url: 'http://<%= yeoman.host %>:<%= connect.options.port %>/es/'
      }
    },
        ...
        files: [
          {
            src: [
              '<%= yeoman.app %>/es',
              '<%= yeoman.app %>/en',
              '<%= yeoman.app %>/i18n/en.json'
            ]
          }
        ]
      },
      views: '<%= yeoman.app %>/views',
      server: '.tmp'
    },
        ...
        files: [
          {
            ...
            src: ['**/*.jade', '!**/mixins/**/*.jade', '!**/includes/**/*.jade'],
    ...
    ngtemplates: {
      dist: {
        options: {
          module: 'ejemploFrontCompletoApp',
